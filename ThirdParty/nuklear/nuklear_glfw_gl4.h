...
NK_API void
nk_glfw3_render_custom(enum nk_anti_aliasing AA)
{
    struct nk_glfw_device *dev = &glfw.ogl;
...
//    glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
    ...
    // NOTE: commented out, since I consier this call redundant and detrimental to performance here.
//    glEnable(GL_SCISSOR_TEST);
            ...
            nk_foreach(cmd, &glfw.ctx)
            {
                ...
                switch (cmd->type) {
                    ...
                    case NK_COMMAND_LINE: {
                        ...
                        DrawLineEx(
                            (Vector2){l->begin.x, l->begin.y},
                            (Vector2){l->end.x, l->end.y},
                    ...
                    case NK_COMMAND_CURVE: {
                        ...
                        DrawLineBezier(
                            (Vector2){q->begin.x, q->begin.y},
                            (Vector2){q->end.x, q->end.y},
                            (float)q->line_thickness,
...
//                        printf("Aliaised line range: %.6f", aliased_r);
                    ...
                    case NK_COMMAND_RECT_FILLED: {
                        ...
                        DrawRectangleRounded(
                            ...
                            r->rounding,
                            1,
                            (Color){(float)r->color.r, (float)r->color.g, (float)r->color.b, (float)r->color.a}
                        );
                    } break;
                    case NK_COMMAND_RECT_MULTI_COLOR: {
                        const struct nk_command_rect_multi_color *r = (const struct nk_command_rect_multi_color*)cmd;
                        Rectangle rect = (Rectangle){(float)r->x, (float)r->y, (float)r->w, (float)r->h};
//                        printf("Drawing Rectangle Gradient!\n");
                        DrawRectangleGradientEx(
                            rect,
                            (Color){
                                (unsigned char)r->left.r, 
                                (unsigned char)r->left.g, 
                                (unsigned char)r->left.b, 
                                (unsigned char)r->left.a
                            },
                            (Color){
                                (unsigned char)r->bottom.r, 
                                (unsigned char)r->bottom.g, 
                                (unsigned char)r->bottom.b,
                                (unsigned char)r->bottom.a
                            },
                            (Color){
                                (unsigned char)r->right.r, 
                                (unsigned char)r->right.g, 
                                (unsigned char)r->right.b, 
                                (unsigned char)r->right.a
                            },
                            (Color){
                                (unsigned char)r->top.r,
                                (unsigned char)r->top.g,
                                (unsigned char)r->top.b,
                                (unsigned char)r->top.a
                            }
                        );
                    ...
                    case NK_COMMAND_CIRCLE: {
                        ...
                        // TODO: add new function with line thickness parameter.
                        printf("Drawing Ellipse Lines!\n");
                        DrawEllipseLines(
                            c->x + c->w / 2,
                            c->y + c->h / 2,
                            c->w / 2,
                            c->h / 2,
                            (Color){
                                (unsigned char)c->color.r,
                                (unsigned char)c->color.g,
                                (unsigned char)c->color.b,
                                (unsigned char)c->color.a
                            }
                        );
                    ...
                    case NK_COMMAND_TRIANGLE: {
                        ...
                        printf("Triangle line thickness: %d\n", t->line_thickness);
                    ...
                    case NK_COMMAND_TEXT: {
                        ...
                        // TODO: ...
//                        printf("NUKLEAR: Handling text command!\n");
